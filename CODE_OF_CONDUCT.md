...
Keystone adopts the **Contributor Covenant v2.1** verbatim. The full
authoritative text lives at:

> https://www.contributor-covenant.org/version/2/1/code_of_conduct/

A local copy of the pledge, standards, and enforcement guidelines
follows so contributors can read it without leaving the repository.

## Our pledge

We as members, contributors, and leaders pledge to make participation
in the Keystone community a harassment-free experience for everyone,
...
pull/merge requests, mailing lists, chat channels, conferences where
the project is represented), and also applies when an individual is
...
1. **Correction** — Private, written warning, with clarity about the
   nature of the violation and an explanation of why it was
...
3. **Temporary ban** — A temporary ban from any sort of interaction or
   ...
   Conduct, is allowed during this period.
